...
[![GoDoc](https://godoc.org/github.com/austin-millan/surf?status.svg)](http://godoc.org/github.com/austin-millan/surf)
...
Work has started on v2.0 on the [v2 branch](https://github.com/austin-millan/surf/tree/v2).
...
### Credits
Surf was started by [Sean Hickey](https://github.com/austin-millan) (austin-millan) to learn more about the Go programming language.
...
[`dev`](https://github.com/austin-millan/surf/tree/dev) branch. Once a milestone has been reached the branch will
...
See [CONTRIBUTING.md](https://raw.githubusercontent.com/austin-millan/surf/master/CONTRIBUTING.md) for more information.


### License
Surf is released open source software released under The MIT License (MIT).
See [LICENSE.md](https://raw.githubusercontent.com/austin-millan/surf/master/LICENSE.md) for more information.
